...
def upload_emotion_class(name_dataset: str):
    ...
    path = os.path.join(os.path.dirname(os.path.dirname(__file__)), f"datasets/{name_dataset}")
    dir_names = [dir for dir in os.listdir(path) if os.path.isdir(os.path.join(path, dir))]
